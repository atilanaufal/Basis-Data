-- Buat Database Lucky_Shrub
CREATE DATABASE Lucky_Shrub;
-- Pilih & Gunakan Database Lucky_Shrub
USE Lucky_Shrub;
...
-- Optimized query using trailing wildcard
