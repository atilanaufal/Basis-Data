...
BEGIN
    ...
    BEGIN
        SELECT 'Error: Email admin sudah terdaftar.'
AS error_message;
    END;

    DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
        SELECT 'Error: Terjadi kesalahan saat menambahkan akun admin.'
AS error_message;
    END;
...
BEGIN
    DECLARE EXIT HANDLER FOR 1062 -- Duplicate key error
    BEGIN
        SELECT 'Error: Email user sudah terdaftar.'
AS error_message;
    END;

    DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
        SELECT 'Error: Terjadi kesalahan saat menambahkan akun user.'
AS error_message;
    END;
...
BEGIN
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
        SELECT 'Error: Terjadi kesalahan saat menambahkan data anak.'
AS error_message;
    END;
...
BEGIN
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
        SELECT 'Error: Terjadi kesalahan saat menambahkan jadwal makan.'
AS error_message;
    END;
...
BEGIN
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
        SELECT 'Error: Terjadi kesalahan saat menambahkan jadwal tidur.'
AS error_message;
    END;
...
BEGIN
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
        SELECT 'Error: Terjadi kesalahan saat menambahkan kegiatan anak.'
AS error_message;
    END;
...
BEGIN
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
        SELECT 'Error: Terjadi kesalahan saat menambahkan riwayat kesehatan.'
AS error_message;
    END;
...
BEGIN
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
        SELECT 'Error: Terjadi kesalahan saat menghapus akun admin.'
AS error_message;
    END;

    DELETE FROM akun_admin WHERE id_admin = p_id_admin;
...
BEGIN
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
        SELECT 'Error: Terjadi kesalahan saat menghapus akun user.'
AS error_message;
    END;

    DELETE FROM akun_user WHERE id_user = p_id_user;
...
BEGIN
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
        SELECT 'Error: Terjadi kesalahan saat menghapus data anak.'
AS error_message;
    END;
...
BEGIN
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
        SELECT 'Error: Terjadi kesalahan saat menghapus jadwal makan.'
AS error_message;
    END;
...
BEGIN
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
        SELECT 'Error: Terjadi kesalahan saat menghapus jadwal tidur.'
AS error_message;
    END;
...
BEGIN
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
        SELECT 'Error: Terjadi kesalahan saat menghapus kegiatan anak.'
AS error_message;
    END;
...
BEGIN
    ...
    UPDATE akun_admin 
    SET nama_admin = p_nama_admin, email = p_email, password = p_password
...
BEGIN
    ...
    UPDATE akun_user 
    SET nama_user = p_nama_user, email = p_email, tipe_user = p_tipe_user, password = p_password
...
BEGIN
    ...
    SET id_user = p_id_user, nama_anak = p_nama_anak, tanggal_lahir = p_tanggal_lahir, 
        ...
        hobi = p_hobi, berat_badan_kg = p_berat_badan, tinggi_badan_cm = p_tinggi_badan
...
CALL tambah_akun_admin('Admin', 'admin@gmail.com', 'admin123');

-- Memanggil stored procedure tambah_akun_user
CALL tambah_akun_user('Daffa', 'daffa@gmail.com', 'orang_tua', 'password123');

-- Memanggil stored procedure tambah_data_anak
CALL tambah_data_anak(1, "Ma'ruf", '2020-01-15', 'laki-laki', 'Bermain', 20.5, 90.2);
...
CALL tambah_jadwal_tidur(1, '21:00:00', '06:00:00');

-- Memanggil stored procedure tambah_kegiatan_anak
CALL tambah_kegiatan_anak(1, 'Belajar', '08:00:00', '10:00:00');
...
BEGIN
    ...
    VALUES ('data_anak', NEW.id_anak, 'INSERT', NEW.id_user, 'user', JSON_OBJECT('id_anak', NEW.id_anak, 'nama_anak', NEW.nama_anak, 'tanggal_lahir', NEW.tanggal_lahir, 'umur', NEW.umur, 'jenis_kelamin', NEW.jenis_kelamin, 'hobi', NEW.hobi, 'berat_badan_kg', NEW.berat_badan_kg, 'tinggi_badan_cm', NEW.tinggi_badan_cm));
END //
DELIMITER ;
...
BEGIN
    ...
    VALUES ('data_anak', NEW.id_anak, 'UPDATE', NEW.id_user, 'user',
            JSON_OBJECT('id_anak', OLD.id_anak, 'nama_anak', OLD.nama_anak, 'tanggal_lahir', OLD.tanggal_lahir, 'umur', OLD.umur, 'jenis_kelamin', OLD.jenis_kelamin, 'hobi', OLD.hobi, 'berat_badan_kg', OLD.berat_badan_kg, 'tinggi_badan_cm', OLD.tinggi_badan_cm),
            JSON_OBJECT('id_anak', NEW.id_anak, 'nama_anak', NEW.nama_anak, 'tanggal_lahir', NEW.tanggal_lahir, 'umur', NEW.umur, 'jenis_kelamin', NEW.jenis_kelamin, 'hobi', NEW.hobi, 'berat_badan_kg', NEW.berat_badan_kg, 'tinggi_badan_cm', NEW.tinggi_badan_cm));
END //
DELIMITER ;
...
BEGIN
    ...
    VALUES ('data_anak', OLD.id_anak, 'DELETE', OLD.id_user, 'user', JSON_OBJECT('id_anak', OLD.id_anak, 'nama_anak', OLD.nama_anak, 'tanggal_lahir', OLD.tanggal_lahir, 'umur', OLD.umur, 'jenis_kelamin', OLD.jenis_kelamin, 'hobi', OLD.hobi, 'berat_badan_kg', OLD.berat_badan_kg, 'tinggi_badan_cm', OLD.tinggi_badan_cm));
END //
DELIMITER ;
...
BEGIN
    ...
    VALUES ('jadwal_makan', NEW.id_jadwal, 'INSERT', CURRENT_USER(), JSON_OBJECT('id_jadwal', NEW.id_jadwal, 'id_anak', NEW.id_anak, 'waktu_sarapan', NEW.waktu_sarapan, 'menu_sarapan', NEW.menu_sarapan)); 
END //
DELIMITER ;
...
BEGIN
    ...
    VALUES ('kegiatan_anak', OLD.id_kegiatan, 'DELETE', CURRENT_USER(), JSON_OBJECT('id_kegiatan', OLD.id_kegiatan, 'id_anak', OLD.id_anak, 'nama_kegiatan', OLD.nama_kegiatan));
END //
DELIMITER ;
