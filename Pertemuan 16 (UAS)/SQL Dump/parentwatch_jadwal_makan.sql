...
CREATE TABLE `jadwal_makan` (
  ...
  KEY `id_anak` (`id_anak`),
  KEY `idx_menu_sarapan` (`menu_sarapan`(100)),
...
INSERT INTO `jadwal_makan` VALUES (1,1,'07:00:00','Roti','12:00:00','Nasi Goreng','19:00:00','Sayur Sop','2024-12-23 11:03:07','2024-12-23 11:03:07'),(2,2,'07:00:00','Bubur Ayam','12:00:00','Udang Goreng','19:00:00','Sayur Sop','2024-12-23 11:03:07','2024-12-23 11:03:07');
